...
(function () {
  ...
  Object.assign(i18n.ct, {
    ...
    idx_about_h2:    "關於我",
    idx_about_p:     "你好，我係孫宇奇（Kevin）。我喺密歇根大學工程學院修讀計算機科學及機器人學。我對自主系統嘅多模態感知好有興趣。喺業餘時間，我鍾意踩單車、寫詩同拉大提琴。",
    idx_inv_h2:      "現時參與",
    idx_inv_mmint:   "研究助理",
  ...
  Object.assign(i18n.en, {
    ...
    rsm_umich_degree:    "<strong>Degree:</strong> Computer Science &amp; Robotics BSE, Sept 2025 – May 2029 (anticipated)",
  ...
  Object.assign(i18n.de, {
    ...
    rsm_umich_degree:    "<strong>Abschluss:</strong> BSE Informatik &amp; Robotik, Sept. 2025 – Mai 2029 (voraussichtlich)",
  ...
  Object.assign(i18n.ct, {
    ...
    rsm_edu_h3:          "學歷",
    rsm_umich_degree:    "<strong>學位：</strong>計算機科學及機器人學理學士，2025年9月 – 2029年5月（預計）",
